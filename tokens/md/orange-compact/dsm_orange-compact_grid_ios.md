...
| ouds.grid.ios.compact.margin | core-ouds.grid.margin.100 | 16px |
...
| ouds.grid.ios.regular.max-width | core-ouds.grid.max-width.ios-regular | 1366px |
| ouds.grid.ios.regular.margin | core-ouds.grid.margin.300 | 24px |
| ouds.grid.ios.regular.column-gap | core-ouds.grid.column-gap.200 | 16px |
