...
La lecture dominante dans le corpus — portée par [[cristian-morales-achiardi]], [[diana-wolosin]], et la majorité des articles de [[romina-kavcic]] — traite de la question suivante : **comment rendre un design system compréhensible et opérable par des agents IA ?**

Dans cette lecture, l'IA est l'utilisateur (ou le mainteneur) du design system. Les humains ont créé le système ; l'IA s'en empare pour composer des interfaces, auditer la cohérence, générer des tokens, détecter des dérives. La question centrale est celle de la [[lisibilite-machine-design-system|lisibilité machine]] : quelles structures de données, quels formats, quelles métadonnées permettent à un agent de naviguer le système avec précision et sans hallucination ?

Les concepts produits par cette lecture : [[trois-couches-composants-agents]], [[schema-metadata-composant]], [[mcp-model-context-protocol]], [[knowledge-graph-design-system]], [[protocole-arc]], [[user-vs-maintainer-ia]], [[existence-vs-intent-violations]], [[concevoir-les-conditions]]. La gouvernance ici est la gouvernance *du* système par l'IA — l'IA comme vérificateur de cohérence, auditeur de tokens, mainteneur des contrats d'architecture.

## Lecture B : Le design system qui documente les fonctionnalités IA pour les humains

L'article "Design Systems That Document AI" ([[design-systems-that-document-ai]]) introduit une lecture différente : **comment un design system documente-t-il les patterns d'interface pour les fonctionnalités IA destinées aux utilisateurs humains ?**
...
[GAP] : Le vault ne contient actuellement aucune source sur l'implémentation concrète des [[quatre-regles-ia-ux]] dans un produit réel, ni sur la construction de composants de niveau 2 ou 3 du [[modele-maturite-ia-design-system]]. C'est un blanc dans le corpus.
