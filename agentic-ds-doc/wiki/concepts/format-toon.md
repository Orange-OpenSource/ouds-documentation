...
TOON est un format de sérialisation utilisé par [cristian-morales-achiardi](../entities/cristian-morales-achiardi.md) pour encoder le codebase index d'un design system agentique. Il est conçu pour être lu par des agents IA de manière optimale : compact, structuré, et économe en tokens ([towards-agentic-design-system](../sources/towards-agentic-design-system.md)).
