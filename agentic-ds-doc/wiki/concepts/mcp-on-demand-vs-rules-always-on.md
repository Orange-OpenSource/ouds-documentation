...
[eddie-machado](../entities/eddie-machado.md) chez Miro documente l'implémentation la plus légère possible de la couche always-on : une seule instruction dans le fichier Claude root de l'équipe, indiquant à Aura d'utiliser le MCP design system pour toutes les questions composants ([miro-ai-design-system-mcp-claude-code-skills](../sources/miro-ai-design-system-mcp-claude-code-skills.md)). Résultat : chute de 70 à 80 % des questions Slack. Les ingénieurs obtenaient leurs réponses dans leur IDE sans devoir demander manuellement.
...
[brad-frost](../entities/brad-frost.md) nomme le même problème depuis l'angle de la conférence IDS 2026 et propose un cadre en trois couches qu'il appelle "progressive disclosure of context" ([your-design-system-is-not-ready-for-ai-agents](../sources/your-design-system-is-not-ready-for-ai-agents.md)) :
...
Cette distinction pointe une lacune dans la série de [cristian-morales-achiardi](../entities/cristian-morales-achiardi.md) : les parties 1 à 6 décrivent l'infrastructure MCP et les métadonnées composant, mais n'articulent pas explicitement le problème des fondations ni la nécessité d'une couche always-on pour les tokens et fondations. La partie 5 ([architecture-skills-rules-instructions](architecture-skills-rules-instructions.md)) introduit les Rules comme fichiers de contexte passif, mais sans nommer le problème des fondations que cette couche résout. Wolosin nomme le problème, Morales Achiardi fournit l'architecture — les deux se complètent.
