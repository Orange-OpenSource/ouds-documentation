...
Un composant context-aware est un composant dont le comportement attendu — token utilisé, règles d'usage, contraintes de composition — varie selon le contexte dans lequel il est instancié. C'est l'une des propriétés centrales d'un [[systeme-de-design-agentique]] : le même composant ne se comporte pas de la même façon selon où il vit dans le produit.

## Exemple : Button dans trois contextes

[[romina-kavcic]] illustre cela avec Button instancié dans trois contextes différents ([[design-system-most-important-asset-ai-era]]) :
