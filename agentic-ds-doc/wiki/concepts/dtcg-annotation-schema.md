...
related:
  ...
  - "[[2026-06-22_description-field-design-token]]"
...
[[romina-kavcic]] propose dans son audit de 50 systèmes ([[50-design-token-files-one-problem]]) un template opérationnel qui combine ces trois éléments. C'est le format le plus complet documenté dans le corpus, fondé sur l'exemple de GitHub Primer — le seul des 50 systèmes à avoir une règle explicite de non-usage dans le fichier.
...
Ce template couvre les 7 questions qu'un agent a besoin ([[readable-vs-usable-token]]) :
