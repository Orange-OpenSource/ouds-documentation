...
La réaction instinctive face aux bypasses — les cas où des équipes n'utilisent pas les composants ou tokens du design system — est de l'interpréter comme un manque de discipline ou d'adhésion. [[romina-kavcic]] propose l'inversion : "If people are bypassing consistently, the system is failing them." ([[20-ai-workflows-design-system-teams]])
...
"Every bypass you fix makes the system easier to use, which makes the next bypass less likely. That is how adoption compounds." ([[20-ai-workflows-design-system-teams]])
