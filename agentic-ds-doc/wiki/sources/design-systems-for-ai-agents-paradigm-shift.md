...
"A Design System cannot limit itself to exposing components. It has to expose judgment." ([[vicente-g]])

"UX Design does not live only inside components. It lives in the relationships between them." ([[vicente-g]])

"The Design System stops being only a component library and documentation hub, and starts becoming a context architecture." ([[vicente-g]])

"When an agent cannot find a rule, it invents one." ([[vicente-g]])

"The future of Design Systems is not only about documenting better. It is about building context better." ([[vicente-g]])

## Connexions identifiées

Converge avec [[ia-comme-utilisateur]] (Wolosin) sur le reformatage du DS pour les machines. Converge avec [[mcp-on-demand-vs-rules-always-on]] (Wolosin) sur la limite intrinsèque du MCP seul. Approfondit [[trois-couches-composants-agents]] (Kavcic) avec la distinction "composants vs relations entre composants". Rejoint [[concevoir-les-conditions]] (Morales Achiardi) sur l'encodage du jugement plutôt que des règles. Apporte le concept nouveau d'[[architecture-contexte-agentique]] — couches progressives par phase de tâche.
