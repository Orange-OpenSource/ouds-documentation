...
**La leçon de gouvernance interne.** L'équipe a été évaluée "4 sur 10 en impact" par un senior leader parce que le travail de métadonnées et documentation n'était "pas fancy". Ils ont continué. La formule d'[[andressa-lombardo]] : "Prove the concept first. Explain it second." — non pas par naïveté mais parce que le MCP ne fonctionne que sur ce qu'Aura peut lire, et ce qu'elle peut lire est aussi bon que ce que quelqu'un a écrit.

## Citations clés

"If we didn't figure out how to make AI work within our system, somebody else was going to do it without us." ([[eddie-machado]])

"She was not randomly wrong, she was confidently wrong." ([[eddie-machado]] sur Aura)

"It wasn't Aura that was struggling. It was actually the fact that we didn't provide her enough context to get the job done." ([[eddie-machado]])

"You don't need a perfect system. You need a system that is legible enough to teach." ([[andressa-lombardo]])

"Prove the concept first. Explain it second." ([[andressa-lombardo]])

## Ce que cette source apporte au vault

Source de production unique dans son registre : le vault contient beaucoup de cadres conceptuels (Morales Achiardi, Wolosin) et de benchmarks (Indeed, Spotify). Miro est différent — c'est le récit d'une équipe petite (6 personnes) qui a avancé pas à pas sur un an, raté, ajusté, et documenté les ajustements concrets. Les concepts nouveaux : [[ia-comme-nouvelle-recrue]], [[skills-avant-mcp]], [[metriques-adoption-ia-design-system]]. Les confirmations empiriques : le do-not-use en métadonnées fonctionne sur les icônes (étend [[readable-vs-usable-token]] au-delà des tokens), l'instruction de routage dans le fichier Claude est l'implémentation la plus légère de [[mcp-on-demand-vs-rules-always-on]], et le client-side rendering est un bloqueur concret documenté en production.
