---
type: entity
tags: [auteur, design-system, gouvernance, ia, blog, formats, agents-md, skill-md, design-md]
created: 2026-07-06
updated: 2026-07-07
sources:
...
Praticien et auteur spécialisé dans les design systems, avec une orientation particulière sur la gouvernance, l'adoption, et les dynamiques organisationnelles. Publie sur blog.murphytrueman.com. A également construit designsystemsforai.com, un outil d'évaluation de la readiness organisationnelle (gouvernance, accountability, modèles de contribution).
...
"The hidden cost of design system entropy" — sur la dynamique d'accumulation des exceptions et de la dérive.
"The component adoption gap" — sur les dynamiques humaines de l'adoption de composants.
"Encouraging design system adoption through empathy and empowerment" — sur la tension autonomie/cohérence dans les modèles de gouvernance.
