...
Le cas d'usage design system ([20-ai-workflows-design-system-teams](../sources/20-ai-workflows-design-system-teams.md)) : construire un validateur de tokens qui scanne les frames sélectionnées et signale les violations (hex hardcodés, tokens primitifs utilisés directement en composants, couleurs de statut dans le mauvais contexte). Ce type de plugin transforme les règles de gouvernance en feedback en temps réel dans Figma — au lieu de les répéter dans les revues.
